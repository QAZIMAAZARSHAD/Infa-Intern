...
const MONTHS = [
  ...
  },
  {
    ...
    items: [
      {
        id: "MDMN-86490",
        text: "Fix e2e tests failing on BUI after tenant model change",
      },
    ],
  },
  {
  ...
  { label: "November '23", notes: ["Future is unpredictable"] },
  { label: "December '23", notes: ["Future is unpredictable"] },
  { label: "January '24", notes: ["Future is unpredictable"] },
];
